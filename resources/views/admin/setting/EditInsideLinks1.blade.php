            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('admin.settindDetail.deleteFile')}}" id="deleteForm" method="post">
                        ...
                        <input type="hidden" name="fileName" value="{{ env('SETTING_VIDEOS_UPLOAD_PATH') . $setting_detail->product_video_name }}" >
        ...
        <div class="col-xl-12 col-md-12 mb-4 p-4 bg-white">
            ...
            <form class="col-12" method="POST" action="{{ route('admin.settindDetail.questions.update') }}"
                ...
                <div class="">
                    ...
                    <input type="text" class="form-control" value="{{ $setting_detail->aparat_product }}" name="aparat_product">
