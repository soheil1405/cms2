                    ...
                    <form action="{{ route('admin.settindDetail.deleteFile') }}" id="deleteForm" method="post">
                        ...
                        @if ($setting_detail->buy_video_name)
                            ...
                            <input type="hidden" name="fileName"
                                value="{{ env('SETTING_VIDEOS_UPLOAD_PATH') . $setting_detail->buy_video_name }}">
    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-md-12 mb-4 p-4 bg-white">
            <div class="mb-4 text-center text-md-right">
                <h5 class="font-weight-bold">ویرایش صفحه (راهنمای خرید) : </h5>
            </div>
            <hr>
            ...
            <form class="col-12" method="POST" action="{{ route('admin.settindDetail.questions.update') }}"
                ...
                <div class="mb-4 text-center text-md-right">
                    ...
                    <input type="text" value="{{ $setting_detail->guidBuyTitle }}" class="form-controll" name="guidBuyTitle">

                </div>

                <div class="mb-4 text-center text-md-right">
                    <label for="">icon :</label>
                    <input type="file" class="form-control" name="guidBuyPic">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-12">
                        <textarea name="Buy_guid_text" id="content" class="ckeditor" rows="6"> {!! $setting_detail->Buy_guid_text !!} </textarea>
                    </div>
                ...
                <div class="">
                    ...
                    <input type="text" class="form-control" value="{{ $setting_detail->aparat_buy }}" name="aparat_buy">
                ...
                <div class="">
                    ...
                    <input type="file" class="form-control" name="buy_video_name"
                        value="{{ $setting_detail->buy_video_name }}">
        ...
        <form action="{{ route('admin.settindDetail.questions.update') }}" id="deleteAparatVideoForm" method="post">
            ...
            <input type="hidden" name="delete_Buy_AparatVideoForm" value="1">
