    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form action="{{ route('admin.settindDetail.deleteFile')}}" id="deleteForm" method="post">
                ...
                @csrf
                @if($setting_detail->Ad_video_name)
                <input type="hidden" name="vendorPageGuid" value="1">
                <input type="hidden" name="page" value="Add">
                <input type="hidden" name="fileName" value="{{ env('SETTING_VIDEOS_UPLOAD_PATH') . $setting_detail->Ad_video_name }}" >
    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-md-12 mb-4 p-4 bg-white">
            <div class="mb-4 text-center text-md-right">
                <h5 class="font-weight-bold">ویرایش صفحه ( تبلیغات ) : </h5>
            </div>
            <hr>
            ...
            <form class="col-12" method="POST" action="{{ route('admin.settindDetail.questions.update') }}"
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-12">
                        <textarea name="AddPage_Guid_Text" id="content" class="ckeditor" rows="6"> {!! $setting_detail->AddPage_Guid_Text !!} </textarea>
                    </div>
                ...
                <div class="">
                    ...
                    <input type="text" class="form-control" value="{{ $setting_detail->aparat_Add }}" name="aparat_Add">
                ...
                <div class="">
                    ...
                    <input type="file" class="form-control" name="Ad_video_name" value="{{ $setting_detail->Ad_video_name }}" >
                ...
                @if ($setting_detail->Ad_video_name)
                    <div class="col-12">
                        ...
                        <video controls>
                            <source src="{{ env('SETTING_VIDEOS_UPLOAD_PATH') . $setting_detail->Ad_video_name }}"
                                type="video/webm" />
                        </video>
            ...
            <form action="{{ route('admin.settindDetail.questions.update') }}" id="deleteAparatVideoForm" method="post">
                ...
                <input type="hidden" name="delete_Add_AparatVideoForm" value="1" >
