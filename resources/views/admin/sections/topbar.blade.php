<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    @if(
        ...
        Route::currentRouteName() != "admin.settindDetail.SiteAdds.edit" &&
        
        
        Route::currentRouteName() != "admin.settindDetail.index" &&
        
        Route::currentRouteName() != "admin.articles.index" &&
        
        
        Route::currentRouteName() != "admin.stories.index" &&
        
        
        Route::currentRouteName() != "admin.sliderss.index" &&
        

        Route::currentRouteName() != "admin.tickets.index" &&
        
        Route::currentRouteName()!='admin.AllSpecialVendors' && Route::currentRouteName() != "admin.allSpecialProducts" && Route::currentRouteName()!= "admin.comments.index" )
    <!-- Topbar Search -->
    ...
    <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in text-right"
                ...
                <a class="dropdown-item" href="{{ route('admin.settindDetail.index') }}">
