...
@section('content')
    ...
    <form action="{{ route('admin.premissions.store') }}" method="post">
        ...
        <div class="row">
            ...
            <div class="col-8 p-4 ">
                ...
                <textarea name="description" id="description" class="form-control" cols="100" rows="5"
                    placeholder="توضیجات دسترسی"></textarea>
        ...
        <hr>
{{-- 
        <label for="select-all" class="selectall" id="select">انتخاب همه</label>
