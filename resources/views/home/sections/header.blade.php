                            ...
                            <ul>
                                ...
                                <li class="angle-shape">
                                    ...
                                    <ul class="mega-menu">
                                        ...
                                        <li>
                                            <a class="menu-title" href="{{ route('vendor.categories.show' , ['category' => $parentCategory->slug,'vendor'=>$vendor->name ]) }}">{{ $parentCategory->name }}</a>

                                            <ul>
                                                @foreach ($parentCategory->children as $childCategory)
                                                    <li><a href="{{ route('vendor.categories.show' , ['category' => $childCategory->slug,'vendor'=>$vendor->name ]) }}">{{ $childCategory->name }}</a></li>
                                                @endforeach
                                            </ul>
                                        </li>
                                        @endforeach
            ...
            <div class="row align-items-center">
                <div class="col-6">
                    <div class="mobile-logo">
                        <a href="{{ route('home') }}">
                            <h4 class="font-weight-bold">{{env('APP_NAME')}}</h4>
                        </a>
                    </div>
                </div>
                <div class="col-6">
