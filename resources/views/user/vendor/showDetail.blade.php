...
@section('content')
    ...
    <h3>
        <img style="border-radius: 50%; width:100px;height:100px; margin:15px; border:1px solid green;"
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success  text-uppercase mb-1">
                                ...
                                مجموع پرداخت های انجام شده توسط فروشگاه شما
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success  text-uppercase mb-1">
                                ...
                                مجموع پرداخت های انجام شده توسط شما
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success  text-uppercase mb-1">
                                ...
                                مجموع پرداخت های انجام شده توسط کاربران
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                ...
                                {{ $EmployeetotalFinalIncreaseCredit + $EmployeetotalFinalPays }}
    ...
    <div class="row">
        ...
        <div class="col-2">
            ...
            @foreach ($vendor->user->AllEmployers as $item)
                ...
                <a href="{{ route('user.showUserDetail', ['id' => $item->id]) }}"
