...
@section('content')
    <div class="col-12">
        ...
        |
        تاریخ عضویت : {{ \Morilog\Jalali\Jalalian::forge($user->created_at) }}


        |
        تاریخ ایجاد فروشگاه : {{ \Morilog\Jalali\Jalalian::forge($user->vendor->created_at) }}
        ...
        <a href="{{ route('user.UserArticles.index') }}" class="btn btn-success">مقالات من</a>


        <a href="{{ route('user.story.index') }}" class="btn btn-success">استوری های من</a>

        <a href="{{ route('user.products.index') }}" class="btn btn-success">محصولات من</a>

        <a href="{{ route('user.go_to_reset_pass') }}" class="btn btn-danger">بازیابی رمز عبور</a>
        <hr>
