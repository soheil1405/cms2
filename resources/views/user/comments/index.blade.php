...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-md-12 mb-4 p-4 ">
            <div class="d-flex flex-column text-center flex-md-row justify-content-md-between rounded bg-white ">
                <h5 class="font-weight-bold  py-4 px-1">لیست دیدگاه ها ({{ count($comments) }})</h5>
                        ...
                        @foreach ($comments as $item)
                            <tr>
                                ...
                                <th>
                                    ...
                                    @else
                                        <a href="{{ route('vendor.home', ['vendor' => Auth::user()->vendor->name]) }}">کامنت
                                            فروشگاه</a>
                                    @endif
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="modalCommentText">
                                                            ...
                                                            <input type="text" required placeholder="پاسخ خود را اینحا وارد کنید" name="comment" class="form-control"
                                                                id="">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                @error('captcha')
                                                                    <p class="text-danger"> فیلد فرم اعتبار سنجی به درستی وارد
                                                                        نشده است </p>
                                                                @enderror
                                                            </div>
                                                        </div>
