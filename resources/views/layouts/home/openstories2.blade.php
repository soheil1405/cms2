...
<main id="storyMain2" style="display: flex; flex-direction: column; width:100%;position:fixed;top:0;">

    <a href="{{route('home')}}"  class="logosefid " style="position:absolute;top:0;left:0;text-align:left;">
        <img src="{{ asset('images/logo/instabarghlogo-min.png') }}" class="img-fluid w-50 text-start" alt="">
    </a>
    <a  href="{{route('home')}}"  class="logosefid " style="position:absolute;top:0;right:20px;;text-align:right;">
        <img src="{{ asset('images/logo/instabarghfarsi-min.png') }}" class="img-fluid w-50 text-start" alt="">
    </a>
    <div class="" style="position: relative;height:100%;background-color:#000;">
        {{-- section 1  --}}
        <div class=""
            style="width:100%; display: flex; justify-content: space-between; position:absolute;top:4%;padding:10px;">

            <a className="more" href="{{ route('vendor.home', ['vendor' => $vendorrr->name]) }}"
                style=" font-size: 20px; color:white;z-index:100000000;" id="vendorName" target="_blank">


                <img src="{{ asset(env('VENDOR_IMAGES_AVATAR_UPLOAD_PATH') . $vendorrr->avatar) }}"
            ...
            @if (request()->has('urlback')) 
                                
 
            href="{{request()->get('urlback')}}"
        ...
        <section id="slide">
                    ...
                    @if ($story->product)
                        <figure>
                            ...
                            <div class="topsection"
                                ...
                                width: 100%;
                                ">
                                <span class=" text-center col-12 p-1 Storytxt" style="font-size: 10px;">
                            ...
                            ">
                                <img class="img-fluid" style="max-height: inherit;"
                                    src="{{ url(env('PRODUCT_IMAGES_UPLOAD_PATH') . $story->media) }}"
                                    alt="{{ url(env('PRODUCT_IMAGES_UPLOAD_PATH') . $story->media) }}" />
                            </div>
                            ...
                            padding : 10px;
                            ">
                                <p class="Storytxt2 text-center p-1 ">{{ $story->text2 }}</p>

                            </div>
                            {{-- section-5  --}}

                            <div class="text-center w-100"
                                style=" position:absolute;bottom:0;padding:10px;z-index:9000000000;
                            ...
                            ">
                                ...
                                <a style=" "
                                    ...
                                    class="btn btn-primary text-center">مشاهده محصول</a>
                            </div>
            ...
            ">
                @if (isset($PrevVendorId))
                    <a href="{{ route('home.stories', ['lastOne'=>$vendorrr->id ,'vId' => $PrevVendorId]) }}"
                        style="position: absolute;right:3px;z-index:10000000000;" class=" btn-shafaf">
                        <
                ...
                @if (isset($nextVendorId))
                    <a href="{{ route('home.stories', ['lastOne'=>$vendorrr->id ,  'vId' => $nextVendorId]) }}"
                        style="position: absolute;left:3px;z-index:10000000000;" class=" btn-shafaf">
                        >
                    </a>
                @endif
            </div>
            ...
            <div id="slide-controls">
                <header style="background-color: #1a1b1c00;">
                    ...
                    <p class="play-pause pause" id="play-pause"></p>
                        ...
                        if (zz - t > 1) {
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    ...
                                    @if(isset($nextVendorId))
                                        window.location.href = "https://instabargh.com/stories/?vId=" +
                                        {{ $nextVendorId }};
                                    @else
                                    ...
                                    $(".vendorBoxProfile").reamoveClass("singlePageStory")                                    
