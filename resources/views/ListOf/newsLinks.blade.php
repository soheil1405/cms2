...
@section('title', ' لینک های جذاب خبری')
...
@section('description',
    ...
    @push('contents')
        <div class="container  ">
            <div class="   g-3 pt-md-3 row pb-3">

                <h2 class="text-center pt-3 pt-md-3"> لینک های جذاب خبری</h2>



                @foreach ($newsLink as $link)
                    <a href="{{ $link->link }}" target="_blank" class=" col-12 col-md-6 px-3   rounded   "
                        style="height: 150px;!important">

                        <div class="bg-white row p-0">
                            <div class="col-3 p-0 " style="height: 150px; ">
                                <img class="" style="height:inherit ;object-fit: cover;"
                                    src="{{ asset(env('NEWS_LINKS_PICS') . $link->pic) }} " alt="Jane">
                            </div>
                            <div class="   text-center col-9 row align-items-center">
                                ...
                                <div class="">
                                    ...
                                    <div class="p-2">
                                        ...
                                        <h2 class="mt-1 h6 text-center"><strong>{{ $link->title }}</strong></h2>

                                        <p class="text-black" style="font-size: 13px;">
                                            {{ Str::limit(strip_tags($link->discription), 120) }}</p>
