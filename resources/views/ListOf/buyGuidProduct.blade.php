...
@section('description', 'اولین و تنهاترین شبکه ی اجتماعی تخصصی بازار صنعت برق ، لوستر و روشنایی ایران | تماس با ما :
    ...
    @push('contents')
        <div class="container  ">
            <div class="row  pt-md-3 ">
                <h2 class="text-center pt-2 pt-md-3"> راهنمای خرید کالا</h2>


                @foreach ($items as $item)
                    <a href="{{ route('home.BuyProductGuid.show', ['id' => $item->id]) }}" class=" col-md-4 mt-2">
                        <div class="rounded border border-danger">
                            <div class=" Articles-card  Articles-card-container img-effect-style  ">
